# Command & Conquer Renegade — Original README

> **Source:** `README.md` from `electronicarts/CnC_Renegade` (GitHub), archived here for historical reference.
> This README was the original C&C Renegade source release documentation, dated approximately 2002 when EA open-sourced the game. It reflects the state of the codebase before the OpenW3D project's modernizations (BGFX backend, OpenAL audio, CMake build system, Linux/macOS support).
