...
# overridable so later DXVK/SDL packaging work can opt into the full stack with
# -DW3D_RENDERER=DXVK -DW3D_CLIENT=ON -DW3D_TOOLS=OFF, etc.
if(NOT DEFINED W3D_CLIENT)
    set(W3D_CLIENT OFF CACHE BOOL "Build full game client.")
endif()
if(NOT DEFINED W3D_FDS)
    set(W3D_FDS OFF CACHE BOOL "Build as headless server.")
endif()
if(NOT DEFINED W3D_TOOLS)
    set(W3D_TOOLS OFF CACHE BOOL "Build additional tools.")
endif()
if(NOT DEFINED W3D_RENDERER)
    set(W3D_RENDERER NULL CACHE STRING "Renderer backend: NATIVE, DXVK, or NULL")
endif()
