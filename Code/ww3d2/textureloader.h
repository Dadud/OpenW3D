...
public:
	...
	static BackendTextureHandle Load_Thumbnail(
		const StringClass& filename);
//		WW3DFormat texture_format);	// Pass WW3D_FORMAT_UNKNOWN if you don't care

	static BackendSurfaceHandle	Load_Surface_Immediate(
		const StringClass& filename,
...
class TextureLoadTaskClass : public TextureLoadTaskListNodeClass
{
	public:
		...
		BackendTextureHandle	Peek_D3D_Texture			(void)				{ return D3DTexture;		}
	...
	private:
		...
		BackendTextureHandle	D3DTexture;
		WW3DFormat				Format;
